        ...
        <div className='md:p-22 md:pt-24 md:pb-22 md:px-40 md:h-full select-none bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] bg-[white] p-8 md:flex justify-normal space-x-28 md:mt-0 mt-6 pt-16'>
            <div className='md:w-6/12'>
                ...
                <div className='md:pt-5'>
                    <h1 className='md:text-5xl text-4xl md:font-medium font-semibold'>MSc <br className='md:hidden' /><span className='bg-gradient-to-r from-[#833be7cb] to-[#5521c5] bg-clip-text text-transparent md:w-48'>Student </span><br /> <span className='md:text-4xl text-3xl font-poppins font-normal md:font-medium'>Network Engineering and Machine Learning</span></h1>
                ...
                <div className='md:w-12/12 md:mt-10 '>
                    <h1 className='font-poppins text-justify'>I am currently an MSc Student in Network Engineering at University of Athens. Also, I work as a Researcher and Software Engineer at Athena Research Center. </h1>
                </div>
            </div>
