...
import { LuHome, LuUser, LuLightbulb, LuPhone } from "react-icons/lu";
  ...
  return (
    <div className="select-none md:flex md:justify-center justify-end md:w-full md:h-12 absolute md:mt-8 md:mr-0 mt-6 md:pt-0 md:pr-0 pr-3">
      ...
      <div className="md:h-12 px-2 border hidden md:px-4 md:flex border-black absolute rounded-full justify-evenly md:space-x-8 space-x-4 hover:scale-110 transition-all duration-300 z-20">
        ...
        <Link to="/about" className="mt-1 w-9 h-9 flex items-center justify-center rounded-full hover:border-spacing-0 hover:scale-110 hover:translate-y-px hover:border-black hover:bg-[#c580f03c] transition-all duration-500">
          <LuUser size={24} />
        </Link>
        <Link to="/skills" className="mt-1 w-9 h-9 flex items-center justify-center rounded-full hover:border-spacing-0 hover:scale-110 hover:translate-y-px hover:border-black hover:bg-[#c580f03c] transition-all duration-500">
          <LuLightbulb size={24} />
        </Link>
      ...
      <div
        className={
          !nav
            ? "md:hidden font-poppins bg-gradient-to-r from-[#833be7e7] rounded-r-xl to-[#5521c595] w-44 h-56 -translate-x-44 absolute mt-10 px-5 text-center text-white transition-all duration-300 z-30"
            : "z-30 md:hidden font-poppins bg-gradient-to-r from-[#833be7e7] rounded-r-xl to-[#5521c595] w-44 h-56 absolute mt-10 px-5 text-center text-white transition-all duration-300"
        }
      >
        <ul>
          <li>
          ...
          <hr />
          <li>
            <Link onClick={handleNav} to="/about" className="block p-4 font-semibold text-md hover:scale-125 active:scale-75 hover:translate-y-px transition-all duration-300 ease-in-out">
              About
            </Link>
          </li>
          <hr />
          <li>
            <Link onClick={handleNav} to="/skills" className="block p-4 font-semibold text-md hover:scale-125 active:scale-75 hover:translate-y-px transition-all duration-300 ease-in-out">
              Skills
            </Link>
          </li>
          <hr />
